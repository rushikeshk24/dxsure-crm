...
function EmployeePayments() {
  ...
  async function fetchPayments() {
    try {
      setLoading(true);
      const response = await axios.get(`${API_BASE}/employeepayments`);
      setPayments(response.data || []);
    } catch (error) {
      console.error("Error loading employee payments:", error);
      alert("Could not load employee payments.");
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleAddPayment(e) {
    ...
    try {
      await axios.post(`${API_BASE}/employeepayments/create`, {
        employeeName,
  ...
  return (
    <div style={styles.page}>
      <h1 style={styles.heading}>Employee Payments</h1>
